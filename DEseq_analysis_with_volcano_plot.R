...
p = EnhancedVolcano(data.frame(res), lab = rownames(res), x = 'log2FoldChange', y = 'padj',ylim = c(0, 15),
                    ...
                    pCutoff = pCutoff, FCcutoff = FCcutoff, pointSize = 0.8, labSize = 4.0,col = c('grey30', 'forestgreen', 'royalblue', 'red2'),colAlpha = 1.0 ,shape = 19,
                    title = "Volcano plot", subtitle = "Mutant vs Wild type",
